...
<?php echo form_open_multipart('admin/c_posyandu2/update_posyandu2'); ?>
	<legend></legend>
<legend></legend>
...
<div class="form-group"> 
	<label class="col-md-3 control-label" for="isi_sturktur">Isi Struktur Kader Posyandu Aster 2</label>
	 <div class="col-md-10">
...
<div class="form-group">
    ...
    <button type="button" class="btn btn-danger" name="batal" id="batal" onclick="location.href='<?= base_url() ?>admin/c_posyandu2'"/>Batal</button>
    </div>
</div>
