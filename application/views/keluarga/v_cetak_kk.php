...
<fieldset>
	...
	<div class="form-group">
		...
		<legend></legend>
		<div class="form-group">
			 <label class="col-md-3 control-label" for="is_sementara_keluarga">Nomor Kartu Keluarga</label>
			 <div class="col-md-9">			 
  ...
  <div class="modal-dialog" style="width: 90%;">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel" ><span class="glyphicon glyphicon-print"></span>&nbsp;Cetak Kartu Keluarga</h4>
      </div>
