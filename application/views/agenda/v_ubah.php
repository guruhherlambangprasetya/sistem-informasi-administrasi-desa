...
<?php echo form_open_multipart('admin/c_agenda/updateAgenda'); ?>
<legend></legend>
<input type="hidden" name="id_agenda" id="id_agenda" value="<?= $hasil->id_agenda?>" readonly = "readonly"/>
...
<div class="form-group">
    ...
    <button type="button" class="btn btn-danger" name="batal" id="batal" onclick="location.href='<?= base_url() ?>admin/c_agenda'"/>Batal</button>
    </div>
</div>
...
function nav_active(){
	...
	var r = document.getElementById("agenda");
