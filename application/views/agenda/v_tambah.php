...
<?php echo form_open_multipart('admin/c_agenda/simpanAgenda'); ?>
<legend></legend>
...
<input type="button" class="btn btn-danger" value="Batal" id="batal" onclick="location.href='<?= base_url() ?>admin/c_agenda'"/>
</span>	
</div>
