...
<center><h3><b>STRUKTUR KADER POSYANDU ASTER 2<br>
    RUKUN WARGA 017 <br>
	...
	<div class="row">
		...
		?>	
		<?php 	
			$id_struktur = $posyandu->id_struktur;
			$judul_struktur = $posyandu->judul_struktur;
			$isi_struktur = $posyandu->isi_struktur;
		?>
		<div class="col-md-4" >
