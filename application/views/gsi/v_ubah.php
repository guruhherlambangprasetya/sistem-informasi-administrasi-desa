...
<?php echo form_open_multipart('admin/c_gsi/update_gsi'); ?>
	<legend></legend>
<legend></legend>
<input type="hidden" name="id_struktur" id="id_struktur" value="<?= $hasil->id_struktur?>" readonly = "readonly"/>
    <div class="form-group">
    	 <label  class="col-md-3 control-label" for="judul_struktur">Judul Struktur Kader GSI </label>
        <div class="col-md-9">
...
<div class="form-group"> 
	<label class="col-md-3 control-label" for="isi_sturktur">Isi Struktur Kader Gsi</label>
	 <div class="col-md-10">
...
<div class="form-group">
    ...
    <button type="button" class="btn btn-danger" name="batal" id="batal" onclick="location.href='<?= base_url() ?>admin/c_gsi'"/>Batal</button>
    </div>
</div>
...
function nav_active(){
	...
	var d = document.getElementById("nav-gsi");
