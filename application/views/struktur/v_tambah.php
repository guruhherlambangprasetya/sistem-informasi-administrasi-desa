...
<?php echo form_open_multipart('admin/c_struktur/simpan_struktur'); ?>
	<legend></legend>
<legend></legend>
	...
	<legend></legend>	
<div class="form-group"> 
	<label class="col-md-3 control-label" for="isi_struktur">Isi Struktur Organisasi</label>
	 <div class="col-md-10">
...
<input type="button" class="btn btn-danger" value="Batal" id="batal" onclick="location.href='<?= base_url() ?>admin/c_struktur'"/>
</span>	
</div>
