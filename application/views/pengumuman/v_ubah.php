...
<?php echo form_open('admin/c_pengumuman/update_pengumuman'); ?>

	<input type="hidden" name="id_pengguna" id="id_pengguna" value="<?= $tempna->id_pengguna ?>" size="20" /> 
	<input type="hidden" name="id_pengumuman" id="id_pengumuman" value="<?= $hasil->id_pengumuman ?>" size="20" />
<legend></legend>
	<div class="form-group"> 
    	<label class="col-md-2 control-label" for="judul_pengumuman">Judul Pengumuman </label>
        <div class="col-md-10">
        <input class="form-control input-md"  type="text" name="judul_pengumuman" id="judul_pengumuman" placeholder="Judul Pengumuman"value="<?= $hasil->judul_pengumuman ?>"/>
		<span class="help-block">
        <?php echo form_error('judul_pengumuman', '<p class="field_error">', '</p>'); ?>
		</span>
		</div>
	</div>
	<div class="form-group"> 
...
<div class="form-group"> 
	<label class="col-md-2 control-label" for="isi_pengumuman">Pengumuman</label>
	 <div class="col-md-10">
	 <textarea class="form-control input-md" id="xxx" name="isi_pengumuman" ><?= $hasil->isi_pengumuman ?></textarea>
	 <span class="help-block">
	</span>
	</div>
</div>
