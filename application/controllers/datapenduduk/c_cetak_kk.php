...
class C_cetak_kk extends CI_Controller {
	...
	function Header($data)
	{
		...
		//judul
		$this->fpdf->Cell(0,15,'KARTU KELUARGA',0,0,'C');
		//pindah baris
	...
	function Content($data)
	{
		...
		foreach($data['KK'] as $rows)
		{
			...
			$this->fpdf->Ln(-20);
			$this->fpdf->Cell(210);
			$this->fpdf->Cell(0,5,'Desa / Kelurahan',0,0,'L');
			$this->fpdf->Cell(-80);
		...
		$this->fpdf->Cell(43,5,'NIK','LTR',0,'C',0);
		$this->fpdf->Cell(25,5,'Jenis','LTR',0,'C',0);
		$this->fpdf->Cell(30,5,'Tempat Lahir','LTR',0,'C',0);
		$this->fpdf->Cell(27,5,'Tanggal Lahir','LTR',0,'C',0);
		$this->fpdf->Cell(25,5,'Agama','LTR',0,'C',0);
		$this->fpdf->Cell(49,5,'Pendidikan','LTR',0,'C',0);
		$this->fpdf->Cell(44,5,'Jenis Pekerjaan','LTR',0,'C',0);
		$this->fpdf->Cell(27,5,'Golongan','LTR',0,'C',0);
		
        $this->fpdf->Ln();
		$this->fpdf->Cell(8,5,' ','LRB',0,'C',0); 
		$this->fpdf->Cell(60,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(43,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(25,5,'Kelamin','LRB',0,'C',0);
		$this->fpdf->Cell(30,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(27,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(25,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(49,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(44,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(27,5,'Darah','LRB',0,'C',0);
		
		$this->fpdf->Ln();
		$this->fpdf->Cell(8,5,'','LRB',0,'C',0);
		$this->fpdf->Cell(60,5,'1','LRB',0,'C',0);
		$this->fpdf->Cell(43,5,'2','LRB',0,'C',0);
		$this->fpdf->Cell(25,5,'3','LRB',0,'C',0);
		$this->fpdf->Cell(30,5,'4','LRB',0,'C',0);
		$this->fpdf->Cell(27,5,'5','LRB',0,'C',0);
		$this->fpdf->Cell(25,5,'6','LRB',0,'C',0);
		$this->fpdf->Cell(49,5,'7','LRB',0,'C',0);
		$this->fpdf->Cell(44,5,'8','LRB',0,'C',0);
		$this->fpdf->Cell(27,5,'9','LRB',0,'C',0);
		...
		foreach($data['Anggota_KK'] as $rows)
		{
			...
			$this->fpdf->Cell(43,5,strtoupper($rows->nik),'LR',0,'L',0);//NIK
			$this->fpdf->Cell(25,5,strtoupper($rows->jen_kel),'LR',0,'C',0);//Jenis Kelamin
			$this->fpdf->Cell(30,5,strtoupper($rows->tempat_lahir),'LR',0,'C',0);//Tempat Lahir
			$this->fpdf->Cell(27,5,date('j/m/Y',strtotime($rows->tanggal_lahir)),'LR',0,'C',0);// Tanggal Lahir
			if($rows->is_diakui=='N')
			{
				$agama='-';
			}
			...
			$this->fpdf->Cell(49,5,strtoupper($rows->pendidikan),'LR',0,'C',0);//Pendidikan
			$this->fpdf->Cell(44,5,strtoupper($rows->pekerjaan),'LR',0,'C',0);//Jenis Pekerjaan
			$this->fpdf->Cell(27,5,strtoupper($rows->goldar),'LR',0,'C',0);//Golongan Darah
		}
		$this->fpdf->Ln();
		...
		$this->fpdf->Cell(27,5,' ','T',0,'C',0);
		$this->fpdf->Cell(45,5,' ','T',0,'C',0);
		$this->fpdf->Cell(45,5,' ','T',0,'C',0);
		////////////////////////////////////////////
		$this->fpdf->Ln();
		$this->fpdf->Cell(8,5,'No','LTR',0,'C',0);
		$this->fpdf->Cell(40,5,'Status','LTR',0,'C',0);
		$this->fpdf->Cell(26,5,'Tanggal','LTR',0,'C',0);
		$this->fpdf->Cell(40,5,'Status Hubungan','LTR',0,'C',0);
		$this->fpdf->Cell(40,5,'Kewarganegaraan','LTR',0,'C',0);
		$this->fpdf->Cell(68,5,'Dokumen Imigrasi','LTB',0,'C',0);
		$this->fpdf->Cell(116,5,'Nama Orang Tua','LRTB',0,'C',0);
		
        $this->fpdf->Ln();
		$this->fpdf->Cell(8,5,' ','LRB',0,'C',0); 
		$this->fpdf->Cell(40,5,'Perkawinan','LRB',0,'C',0);
		$this->fpdf->Cell(26,5,'Perkawinan','LRB',0,'C',0);
		$this->fpdf->Cell(40,5,'Dalam Keluarga','LRB',0,'C',0);
		$this->fpdf->Cell(40,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(34,5,'No.Paspor','LRB',0,'C',0);
		$this->fpdf->Cell(34,5,'No. KITAP','LRB',0,'C',0);
		$this->fpdf->Cell(58,5,'Ayah','LRB',0,'C',0);
		$this->fpdf->Cell(58,5,'Ibu','LRB',0,'C',0);
		
		$this->fpdf->Ln();
		$this->fpdf->Cell(8,5,' ','LRB',0,'C',0);
		$this->fpdf->Cell(40,5,'10','LRB',0,'C',0);
		$this->fpdf->Cell(26,5,'11','LRB',0,'C',0);
		$this->fpdf->Cell(40,5,'12','LRB',0,'C',0);
		$this->fpdf->Cell(40,5,'13','LRB',0,'C',0);
		$this->fpdf->Cell(34,5,'14','LRB',0,'C',0);
		$this->fpdf->Cell(34,5,'15','LRB',0,'C',0);
		$this->fpdf->Cell(58,5,'16','LRB',0,'C',0);
		$this->fpdf->Cell(58,5,'17','LRB',0,'C',0);
		...
		foreach($data['Anggota_KK'] as $rows)
		{
			...
			$this->fpdf->Cell(26,5,strtoupper($rows->tanggal_kawin),'LR',0,'L',0);//Tanggal Perkawinan
			...
			$this->fpdf->Cell(34,5,strtoupper($rows->no_paspor),'LR',0,'L',0);//No. Paspor
			$this->fpdf->Cell(34,5,strtoupper($rows->no_kitas),'LR',0,'L',0);// No. KITAP
			$this->fpdf->Cell(58,5,strtoupper($rows->nama_ayah),'LR',0,'L',0);//Ayah
			$this->fpdf->Cell(58,5,strtoupper($rows->nama_ibu),'LR',0,'L',0);//Ibu
			
		}
		$this->fpdf->Ln();
		$this->fpdf->Cell(8,5,' ','T',0,'C',0);
		$this->fpdf->Cell(40,5,' ','T',0,'C',0);
		$this->fpdf->Cell(26,5,' ','T',0,'C',0);
		$this->fpdf->Cell(40,5,' ','T',0,'C',0);
		$this->fpdf->Cell(40,5,' ','T',0,'C',0);
		$this->fpdf->Cell(34,5,' ','T',0,'C',0);
		$this->fpdf->Cell(34,5,' ','T',0,'C',0);
		$this->fpdf->Cell(60,5,' ','T',0,'C',0);
	}
